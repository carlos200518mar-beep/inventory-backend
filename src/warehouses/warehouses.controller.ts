...
export class WarehousesController {
  ...
  async findAll(@Query() pagination: PaginationDto) {
    const { warehouses, total } = await this.service.findAll(pagination);
    return new StandardResponseDto(warehouses, new PaginationMetaDto(pagination.page!, pagination.limit!, total));
  }
